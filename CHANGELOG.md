...
- dbc6ae9: Improve workspace downloading functionality to allow more leniency to network error cases.

## 2.0.1

### Patch Changes

- 7736638: Modify included config file to contain missing URL value
